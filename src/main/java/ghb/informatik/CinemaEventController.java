...
public class CinemaEventController {
    ...
    */    
    private void createDemoData(){
        ...
        m5 = new Movie("Star Wars Episode 3");
        m5.setDesc("Alle werden sterben außer der Protagonist");
        m5.setImgLink("https://m.media-amazon.com/images/I/51KCZ507V3L._SY445_.jpg");
        m5.setFsk(12);
        m5.setLength(172);
        m5.setLink("https://de.wikipedia.org/wiki/Star_Wars:Episode_I%E2%80%93_Die_dunkle_Bedrohung");

        m6 = new Movie("Hardcore");
        m6.setDesc("krasses Blutbad");
        m6.setImgLink("https://m.media-amazon.com/images/I/51KCZ507V3L._SY445_.jpg");
        m6.setFsk(18);
        m6.setLength(160);
        m6.setLink("https://de.wikipedia.org/wiki/Star_Wars:Episode_I%E2%80%93_Die_dunkle_Bedrohung");
        ...
        ce9 = new CinemaEvent(8, m5, ch1, "18.12.2023, 23:30 Uhr");
        ce10 = new CinemaEvent(9, m6, ch2, "19.10.2023, 22:30 Uhr");
    }
    ...
    private CinemaEvent getCe9() {
        return ce9;
    }
    private CinemaEvent getCe10() {
        return ce10;
    }
